...
const ROWS: Row[] = [
  ...
  ['Kale', 'veg', '1 cup (75g):L|3 cups (222g):M gos fn|4 cups (275g):H gos'],
  ...
  ['Bell pepper, green', 'veg', '1/2 cup (75g):L|1.75 cups (250g):M fn|2 cups (310g):H fn'],
  ['Bell pepper, red', 'veg', '1/3 cup (43g):L|1 cup (100g):M fr'],
  ['Potato, white', 'veg', '1 medium (150g):L', 'Low at any reasonable serving.'],
  ['Pumpkin (kent / Japanese)', 'veg', '1/2 cup (75g):L|1 cup (162g):L|1.5 cups (200g):M fn'],
  ['Radish', 'veg', '2 radishes (70g):L'],
  ['Seaweed, nori', 'veg', '2 sheets (5g):L'],
  ['Shallots', 'veg', '1 tbsp (10g):H fo'],
  ['Spinach, baby', 'veg', '1.5 cups (75g):L|3 cups (150g):M fn'],
  ['Spinach, English', 'veg', '2 cups (75g):L|large serve (500g):L'],
  ...
  ['Tomato, canned', 'veg', '1/2 cup (100g):L|2/3 cup (132g):M fr'],
  ...
  ['Banana, firm (just yellow)', 'fruit', '1 medium (100g):L|1 large (110g):M fn'],
  ['Banana, ripe (spotty)', 'fruit', '1/3 medium (35g):L|1 medium (100g):H fn|1/2 medium (45g):M fn'],
  ...
  ['Honeydew melon', 'fruit', '1/2 cup (90g):L|1 cup (150g):H fn|2/3 cup (116g):M fn'],
  ['Kiwifruit (green or gold)', 'fruit', '2 small (150g):L|4 small (275g):M fn'],
  ['Lemon / lime juice', 'fruit', '1/4 cup (60ml):L'],
  ['Lychee', 'fruit', '2 lychees (20g):L|5 lychees (50g):H so'],
  ['Mandarin', 'fruit', '1 medium (90g):L|1 large (100g):H fr'],
  ['Mango', 'fruit', '1/4 cup (40g):L|1/2 cup (80g):H fr'],
  ['Nectarine', 'fruit', '1/8 nectarine (15g):L|1 medium:H so fn'],
  ['Orange', 'fruit', '1 medium (130g):L|1 1/4 oranges (155g):M fr'],
  ...
  ['Pineapple, fresh', 'fruit', '1 cup (140g):L|1 1/4 cups (200g):M fn'],
  ...
  ['Pasta, gluten-free (cooked)', 'grain', '1 cup (145g):L|large serve (421g):L|3 cups (422g):M fn'],
  ['Noodles, rice (cooked)', 'grain', '1 cup (190g):L|large serve (500g):L'],
  ...
  ['Quinoa', 'grain', '1 cup cooked (155g):L|3 cups cooked (500g):L'],
  ...
  ['Cheese, cheddar', 'dairy', '2 slices (40g):L|large serve (500g):L', 'Hard and aged cheeses are naturally very low in lactose.'],
  ...
  ['Sardines, canned (in oil or water)', 'protein', '1 small can (90g):L', 'FODMAP-free when plain. Avoid sardines in tomato, onion or garlic sauces.'],
  ...
  ['Tofu, firm', 'protein', '2/3 cup (170g):L|over 170g (175g):M gos fn', 'Pressing drains away GOS.'],
  ['Tofu, silken', 'protein', '1/2 cup (120g):H gos fn'],
  ['Tempeh', 'protein', '1 serve (100g):L|large serve (170g):L|over 219g (220g):H fn gos'],
  ...
  ['Edamame', 'legume', '1/2 cup (75g):L|1.5 cups (195g):M fn|2 cups (250g):H fn'],
  ...
  ['Pecans', 'nut', '10 halves (20g):L|40 halves (100g):M fn'],
  ['Pine nuts', 'nut', '1 tbsp (14g):L|1/4 cup:M fn'],
  ['Pistachios', 'nut', '15 nuts (15g):H gos fn'],
  ['Walnuts', 'nut', '10 halves (30g):L'],
  ['Peanut butter', 'nut', '2 tbsp (32g):L|4 tbsp (64g):M gos'],
  ['Almond butter', 'nut', '1 tbsp (20g):L|2 tbsp:M gos'],
  ['Chia seeds', 'nut', '2 tbsp (24g):L|2.5 tbsp (37g):M fn|3 tbsp (44g):H gos fn'],
  ...
  ['Chocolate, dark', 'sweet', '5 squares (30g):L|1 bar (125g):M fn'],
...
const FODMAP_FREE = new Set(
  ...
  shrimp-prawns sardines-canned-in-oil-or-water carrot spinach-english lettuce-iceberg-butter-cos-coral soy-sauce
  eggs bacon olive-oil-vegetable-oils garlic-infused-oil onion-infused-oil ghee water-sparkling-water
